...
from ea_subtree import reproduce_subtree
...
def run_one_seed(seed: int) -> None:
    """Run one independent subtree-replacement experiment."""

    print()
    print("=" * 50)
    print(f"SUBTREE MUTATION - SEED {seed}")
    print("=" * 50)

    set_seed(seed)

    output_dir = CURRENT_PATH / "results" / "subtree"
